...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('shoppers-master/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('shoppers-master/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('shoppers-master/css/jquery-ui.css') }}">
    <link rel="stylesheet" href="{{ asset('shoppers-master/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('shoppers-master/css/owl.theme.default.min.css') }}">
...
<body>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-4 order-3 order-md-3 text-right">
                            <div class="site-top-icons">
                                <ul>
                                    @if (!Auth::check())
                                        <a href="/login" class="btn btn-primary btn-lg text-white" tabindex="-1"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <a href="#" class="block-6">
                            <img src="{{ asset('shoppers-master/images/hero_1.jpg') }}" alt="Image placeholder"
                ...
                <div class="row pt-5 mt-5 text-center">
                    <div class="col-md-12">
                        <p>
                            ...
                            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>___scripts_1___ All rights reserved | This template is made
    ...
    <script src="{{ asset('shoppers-master/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('shoppers-master/js/owl.carousel.min.js') }}"></script>
